...
export default function Projects() {
  return (
    <div
      name="projects"
      className="w-full h-screen text-primary bg-white relative snap-start"
    >
      ...
      <div className="max-w-[1000px] p-4 flex flex-col justify-center w-full h-full  absolute top-0 left-0 right-0 mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div
            style={{ backgroundImage: `url(${zapp})` }}
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100 text-center">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://github.com/grantliunz/grantliu.com"
                  target="_blank"
                  rel="noreferrer"
                  className=""
                >
          ...
          {/* Grid item */}
          <div
            style={{ backgroundImage: `url(${pythonArcade})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div "
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 ">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://github.com/grantliunz/arcade-platformer"
                  target="_blank"
                  rel="noreferrer"
                  className=""
                >
